        ...
        <div className="grid max-md-grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            ...
            <p className="text-sm mt-6 text-gray-300">
              ...
              providing you with credible and timely information on the issues
              that matter most. We cover a wide range of topics including
              politics, business, technology, sports, culture, and more.
            </p>
